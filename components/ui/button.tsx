...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide",
  {
    variants: {
      variant: {
        default:
          "bg-white text-black border-slate-200 border-2 border-b-4 active:border-b-2 hover:bg-orange-100 text-slate-500",
        primary:
          "bg-orange-400 text-primary-foreground hover:bg-orange-500/90 border-orange-600 border-b-4 active:border-b-0",
        primaryOutline: " bg-white text-orange-500 hover:bg-orange-100",
        secondary:
          "bg-blue-500 text-primary-foreground hover:bg-blue-500/90 border-blue-600 border-b-4 active:border-b-0",
        secondaryOutline: " bg-white text-blue-500 hover:bg-blue-100",
        ...
        sidebar:"bg-transparent border-2 text-slate-500 border-2 border-transparent hover-bg-slate-100 transition-none",

        sidebarOutline:"bg-sky-500/15 text-sky-500 border-sky-500 border-2 hover-bg-sky-500/20  transition-none",
